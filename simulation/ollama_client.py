...
DEFAULT_MIN_P = 0.05
DEFAULT_NUM_CTX = 2048   # Context window; kept small so the 9.6GB model fits fully on a 12GB GPU
DEFAULT_NUM_GPU = 999    # Force-place as many layers as possible on GPU (prevents auto-CPU-offload)
API_TIMEOUT = 60
    ...
    def generate(
        ...
        try:
            payload = {
                ...
                "prompt": prompt,
                "stream": False,
                "think": False,  # Disable Gemma4 "thinking mode" — prevents tokens
                                 # being consumed by chain-of-thought before JSON output
                "options": {
